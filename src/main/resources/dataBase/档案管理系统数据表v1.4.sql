...
CREATE TABLE `birthday_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1519 DEFAULT CHARSET=utf8 COMMENT='出生日期信息认定表';

-- ----------------------------
-- Records of birthday_info
-- ----------------------------
INSERT INTO `birthday_info` VALUES ('1517', null, '刘溜溜', '1966-07-02', null, '1996-07-02', '最新任免表记载1966.07出生，最早形成材料高中等学生招生预选登记表记载出生时间为1966.08，还有大专院校毕业生登记表记载出生时间为1966年06月。', '根据省公司“出生日期允许出入55天内”的要求，经组织认定，其出生日期按身份证日期为1966.07', '出生日期前后不一致', '允许出生日期相差55天（阴阳历情况）', '认定结果与身份证一致', null, '2021-01-30 17:49:08');
INSERT INTO `birthday_info` VALUES ('1518', null, '周某某', '1966-07-02', null, '1996-07-02', '最新任免表记载1966.07出生，最早形成材料高中等学生招生预选登记表记载出生时间为1966.08，还有大专院校毕业生登记表记载出生时间为1966年06月。', '根据省公司“出生日期允许出入55天内”的要求，经组织认定，其出生日期按身份证日期为1966.07', '出生日期前后不一致', '允许出生日期相差55天（阴阳历情况）', '认定结果与身份证一致', null, '2021-01-30 17:49:08');
...
CREATE TABLE `education_career_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='学位学历信息详细表';
...
CREATE TABLE `education_info` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1519 DEFAULT CHARSET=utf8 COMMENT='学历信息认定表';

-- ----------------------------
-- Records of education_info
-- ----------------------------
INSERT INTO `education_info` VALUES ('1517', null, '刘溜溜', null, null, '补充相关材料', '1、档案记载1985.09-1989.07就读华东工学院电子工程系电子工程专业全日制本科，缺少学生登记表。\n2、档案记载1992.09-1995.04就读华南理工大学无线电工程系通信与电子系统专业研究生，缺少研究生登记表、成绩单', '1、 学生登记表为一般性材料,经组织研究认定其具有华东工学院电子工程系电子工程专业全日制本科学历。\n2、 本人无法补充华南理工大学无线电工程系通信与电子系统专业研究生研究生登记表、成绩单，本人提供研究生学历鉴定报告，经组织研究认定其具有研究生学历。', '本科', '学士', '无问题', null, '2021-01-30 17:49:08');
INSERT INTO `education_info` VALUES ('1518', null, '周某某', null, null, '补充相关材料', '1、档案记载1985.09-1989.07就读华东工学院电子工程系电子工程专业全日制本科，缺少学生登记表。\n2、档案记载1992.09-1995.04就读华南理工大学无线电工程系通信与电子系统专业研究生，缺少研究生登记表、成绩单', '1、 学生登记表为一般性材料,经组织研究认定其具有华东工学院电子工程系电子工程专业全日制本科学历。\n2、 本人无法补充华南理工大学无线电工程系通信与电子系统专业研究生研究生登记表、成绩单，本人提供研究生学历鉴定报告，经组织研究认定其具有研究生学历。', '本科', '学士', '无问题', null, '2021-01-30 17:49:08');
...
CREATE TABLE `employee_info` (
  ...
  `update_time` datetime DEFAULT NULL COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1532 DEFAULT CHARSET=utf8 COMMENT='员工基本信息表';

-- ----------------------------
-- Records of employee_info
-- ----------------------------
INSERT INTO `employee_info` VALUES ('1530', null, '刘溜溜', '信息化营销中心', '普通员工', '集客线', '1', '1', '最新任免表记载1966.07出生，最早形成材料高中等学生招生预选登记表记载出生时间为1966.08，还有大专院校毕业生登记表记载出生时间为1966年06月。', '根据省公司“出生日期允许出入55天内”的要求，经组织认定，其出生日期按身份证日期为1966.07', '1966-07-02', null, '1996-07-02', '出生日期前后不一致', '允许出生日期相差55天（阴阳历情况）', '认定结果与身份证一致', '无问题', '沃尔夫家偶尔玩', '软件饿哦网球拍', null, 'rejwpqo ', null, 'jfodsajp ', '啊发的视频', 'rl;qrjeowpqjwq ', '1999-02-01', '1999-02-01', null, 'i4329014u', 'ofdsh9w ', '1、档案记载1985.09-1989.07就读华东工学院电子工程系电子工程专业全日制本科，缺少学生登记表。\n2、档案记载1992.09-1995.04就读华南理工大学无线电工程系通信与电子系统专业研究生，缺少研究生登记表、成绩单', '1、 学生登记表为一般性材料,经组织研究认定其具有华东工学院电子工程系电子工程专业全日制本科学历。\n2、 本人无法补充华南理工大学无线电工程系通信与电子系统专业研究生研究生登记表、成绩单，本人提供研究生学历鉴定报告，经组织研究认定其具有研究生学历。', null, null, '本科', '学士', '补充相关材料', '无问题', '1、**学校**学院**专业\n2、学历：研究生\n3、学位：X学硕士', '1、**学校**学院**专业\n2、学历：本科\n4、学位：X学学士、X学学士', '1、**学校**学院**专业\n2、学历：大专', '最新任免表记载1989.07-1992.08江西电机厂工作，缺少该段工作结束时间证明材料。', '无问题', '0', 'lzz', null, null);
INSERT INTO `employee_info` VALUES ('1531', null, '周某某', '信息化营销中心', '普通员工', '集客线', '1', '1', '最新任免表记载1966.07出生，最早形成材料高中等学生招生预选登记表记载出生时间为1966.08，还有大专院校毕业生登记表记载出生时间为1966年06月。', '根据省公司“出生日期允许出入55天内”的要求，经组织认定，其出生日期按身份证日期为1966.07', '1966-07-02', null, '1996-07-02', '出生日期前后不一致', '允许出生日期相差55天（阴阳历情况）', '认定结果与身份证一致', '无问题', '沃尔夫家偶尔玩', '软件饿哦网球拍', null, 'rejwpqo ', null, 'jfodsajp ', '啊发的视频', 'rl;qrjeowpqjwq ', '1999-02-01', '1999-02-01', null, 'i4329014u', 'ofdsh9w ', '1、档案记载1985.09-1989.07就读华东工学院电子工程系电子工程专业全日制本科，缺少学生登记表。\n2、档案记载1992.09-1995.04就读华南理工大学无线电工程系通信与电子系统专业研究生，缺少研究生登记表、成绩单', '1、 学生登记表为一般性材料,经组织研究认定其具有华东工学院电子工程系电子工程专业全日制本科学历。\n2、 本人无法补充华南理工大学无线电工程系通信与电子系统专业研究生研究生登记表、成绩单，本人提供研究生学历鉴定报告，经组织研究认定其具有研究生学历。', null, null, '本科', '学士', '补充相关材料', '无问题', '1、**学校**学院**专业\n2、学历：研究生\n3、学位：X学硕士', '1、**学校**学院**专业\n2、学历：本科\n4、学位：X学学士、X学学士', '1、**学校**学院**专业\n2、学历：大专', '最新任免表记载1989.07-1992.08江西电机厂工作，缺少该段工作结束时间证明材料。', '无问题', '0', 'yyj', null, null);
...
CREATE TABLE `join_party_time_info` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1519 DEFAULT CHARSET=utf8 COMMENT='入党时间信息认定表';

-- ----------------------------
-- Records of join_party_time_info
-- ----------------------------
INSERT INTO `join_party_time_info` VALUES ('1517', null, '刘溜溜', null, 'rejwpqo ', null, '无问题', '沃尔夫家偶尔玩', '软件饿哦网球拍', 'jfodsajp ', null, '2021-01-30 17:49:08');
INSERT INTO `join_party_time_info` VALUES ('1518', null, '周某某', null, 'rejwpqo ', null, '无问题', '沃尔夫家偶尔玩', '软件饿哦网球拍', 'jfodsajp ', null, '2021-01-30 17:49:08');
...
CREATE TABLE `starting_job_time_info` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1519 DEFAULT CHARSET=utf8 COMMENT='参加工作时间基本信息认定表';

-- ----------------------------
-- Records of starting_job_time_info
-- ----------------------------
INSERT INTO `starting_job_time_info` VALUES ('1517', null, '刘溜溜', '1999-02-01', '1999-02-01', null, '啊发的视频', 'i4329014u', 'rl;qrjeowpqjwq ', 'ofdsh9w ', null, '2021-01-30 17:49:08');
INSERT INTO `starting_job_time_info` VALUES ('1518', null, '周某某', '1999-02-01', '1999-02-01', null, '啊发的视频', 'i4329014u', 'rl;qrjeowpqjwq ', 'ofdsh9w ', null, '2021-01-30 17:49:08');
...
CREATE TABLE `work_experience_info` (
  ...
  `update_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1519 DEFAULT CHARSET=utf8 COMMENT='工作经历信息认定表';

-- ----------------------------
-- Records of work_experience_info
-- ----------------------------
INSERT INTO `work_experience_info` VALUES ('1517', null, '刘溜溜', '1、**学校**学院**专业\n2、学历：研究生\n3、学位：X学硕士', '1、**学校**学院**专业\n2、学历：大专', '1、**学校**学院**专业\n2、学历：本科\n4、学位：X学学士、X学学士', '最新任免表记载1989.07-1992.08江西电机厂工作，缺少该段工作结束时间证明材料。', null, '2021-01-30 17:49:08');
INSERT INTO `work_experience_info` VALUES ('1518', null, '周某某', '1、**学校**学院**专业\n2、学历：研究生\n3、学位：X学硕士', '1、**学校**学院**专业\n2、学历：大专', '1、**学校**学院**专业\n2、学历：本科\n4、学位：X学学士、X学学士', '最新任免表记载1989.07-1992.08江西电机厂工作，缺少该段工作结束时间证明材料。', null, '2021-01-30 17:49:08');
